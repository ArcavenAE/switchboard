class Switchboard < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/arcavenae/switchboard/releases/download/TAG_PLACEHOLDER/switchboard-darwin-arm64"
    sha256 "SHA256_ARM64_PLACEHOLDER"
  else
    url "https://github.com/arcavenae/switchboard/releases/download/TAG_PLACEHOLDER/switchboard-darwin-amd64"
